<?php echo e(Form::model($user,array('route' => array('userUpdate', $user->id), 'method' => 'GET'))); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if(\Auth::user()->type == 'company'): ?>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('role', __('Staff Department*'),['class'=>'form-label'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::text('designation',null,array('class'=>'form-control','placeholder'=>__('Enter Designation')))); ?>
...
<?php echo e(Form::close()); ?><?php /**PATH C:\wamp64\www\versedbc\resources\views/user/edit.blade.php ENDPATH**/ ?>
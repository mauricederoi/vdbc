                                ...
                                <div class="col-lg-10 col-md-10">
                                    <div class="theme-detail-card card">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4 ">
                                            <h5 class="mb-0"><?php echo e(__('Edit Personal Info')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
															...
															<div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::textarea('description', $business->description, ['class' => 'form-control description-text', 'rows' => '3', 'cols' => '30', 'id' => $stringid . '_desc', 'placeholder' => __('Enter Description')])); ?>
...
unset($__errorArgs, $__bag); ?>
															...
															<div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::textarea('description', $business->description, ['class' => 'form-control description-text', 'rows' => '3', 'cols' => '30', 'id' => $stringid . '_desc', 'placeholder' => __('Enter Description'),'readonly' => true])); ?>
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="bussiness-hours-header">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-lg-5">
                                                                                            <span><?php echo e(__('Button Title')); ?></span>
                                                                                        </div>
                                                                                        <div class="col-lg-2">
                                    ...
                                    <?php echo e(Form::open(['route' => ['business.qrcode_setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                                        ...
                                        <div class="theme-detail-card" style="box-shadow: 0 6px 30px rgba(182, 186, 203, 0.3); background: #ffffff">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('Forground Color', __('Foreground Color'), ['class' => 'form-label'])); ?>
                                                    ...
                                                    <div id="text_div">
                                                        <div class="col-md-12 mt-2 " >
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="qr_text" maxlength="10" value="<?php echo e(isset($qr_detail->qr_text)?$qr_detail->qr_text:''); ?>" class="form-control qr_text qr_keyup">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
						...
						<div class="row gy-4">
                                 <div class="col-lg-10 col-md-10">
                                    <div class="theme-detail-card" style="box-shadow: 0 6px 30px rgba(182, 186, 203, 0.3); background: #ffffff;">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4 ">
                                            <h5 class="mb-0"><?php echo e(__('Thumbnail')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('google_analytic', __('Google Analytics'), ['class' => 'form-label'])); ?>
